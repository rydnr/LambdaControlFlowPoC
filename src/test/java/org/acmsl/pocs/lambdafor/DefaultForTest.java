 ...
 ******************************************************************************
 *
 * Filename: DefaultForTest.java
 *
 * Author: Jose San Leandro Armendariz
 *
 * Description: Tests for DefaultFor.
 *
 * Date: 2014/08/22
 * Time: 11:47
 *
...
/**
 * Tests for {@link org.acmsl.pocs.lambdafor.DefaultFor}.
 * @author <a href="mailto:queryj@acm-sl.org">Jose San Leandro</a>
 * @since 0.0
 * Created: 2014/08/22 11:47
 */
@ThreadSafe
@RunWith(JUnit4.class)
public class DefaultForTest
{
    /**
     * Checks DefaultFor iterates through all items.
     */
    @Test
    public void for_iterates_through_all_items()
    {
        ...
        new DefaultFor<Collection<Integer>, Integer>()
            .iterate(
                items,
                (t) -> {
